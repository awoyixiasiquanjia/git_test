 ...
 * 显示GIF图片
 * 
 * Created by xq on 2017/7/4.
 * 
 */
@Deprecated
public class NewGifView extends View {
    ...
    public NewGifView(Context context) {
        this(context, null);
    }

    public NewGifView(Context context, AttributeSet attrs) {
        this(context, attrs, R.styleable.CustomTheme_gifViewStyle);
    }

    public NewGifView(Context context, AttributeSet attrs, int defStyle) {
