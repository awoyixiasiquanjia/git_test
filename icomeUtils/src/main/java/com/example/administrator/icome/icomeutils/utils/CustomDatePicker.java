...
public class CustomDatePicker {
    ...
    public CustomDatePicker(Context context, ResultHandler resultHandler, String startDate, String endDate) {
        if (isValidDate("1900-01-01 00:00", "yyyy-MM-dd HH:mm") && isValidDate(endDate, "yyyy-MM-dd HH:mm")) {
            canAccess = true;
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.setContentView(R.layout.custom_date_pickers);
    ...
    private void initParameter() {
        ...
        endYear = endCalendar.get(Calendar.YEAR)+500;
     ...
     * @param isShow
     */
    public void showSpecificDay(boolean isShow){
        if (canAccess) {
            if (isShow) {
